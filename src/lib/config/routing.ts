 ...
 * Valhalla base URL lives only on the server (`VALHALLA_BASE_URL` env).
 */

/** Hard cap on trace points per Valhalla map-matching request (public demos are picky). */
...
/** Minimum distinct points needed to call Valhalla. */
